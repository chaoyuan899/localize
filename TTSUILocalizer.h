...
//
@interface TTSUILocalizer : NSObject{
@private
    id owner_;
...
@property(nonatomic, strong) IBOutlet id owner;
@property(nonatomic, strong) IBOutlet id otherObjectToLocalize;
@property(nonatomic, strong) IBOutlet id yetAnotherObjectToLocalize;
